...
DATASETS: tuple[DatasetSpec, ...] = (
    ...
    _spec("workflow_artifacts", "workflow-execution", classification="sensitive", retention="workflow-temp-7d", readers=("workflow-execution", "application-gateway", "data-operation", "rule-adapter", "analysis-prediction", "content-adapter", "document-table-parsing"), writers=("workflow-execution",), required=("artifact_id", "workflow_instance_id", "dataset")),
