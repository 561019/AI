...
def make_internal_envelope(trace_id: str, actor: dict[str, Any], task_id: str, capability: str, target_layer: str, target_module: str, payload: dict[str, Any], *, source_layer: str = "business_engine", source_module: str = "workflow-execution") -> dict[str, Any]:
    return {
        ...
        "context": {"project_id": "platform-runtime", "conversation_id": task_id, "locale": "zh-CN"},
