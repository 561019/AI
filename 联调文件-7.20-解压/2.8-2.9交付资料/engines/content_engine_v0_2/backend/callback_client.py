...
def build_callback_options(req: Any, default_source_service: str) -> dict[str, Any]:
    ...
    return {
        ...
        "workflow_instance_id": getattr(req, "workflow_instance_id", None) or getattr(req, "parent_task_id", None) or input_payload.get("workflow_instance_id"),
...
def _actor_id(req: Any) -> str:
    ...
    return getattr(req, "operator_real_person_id", None) or actor.get("real_person_id") or actor.get("actor_id") or actor.get("id") or "system"
