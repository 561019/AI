...
defineProps({
  ...
  contextHint: { type: Function, required: true }, sessionTimeline: { type: Array, default: () => [] },
...
const emit = defineEmits(['select-conversation', 'open-command-record', 'dispatch-alert'])
</script>
